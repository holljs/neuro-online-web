...
export default function SignInForm() {
  const handleVkAuth = () => {
    // Вход через VK ID (авторизация ВКонтакте)
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 shadow-sm text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Быстрая и безопасная авторизация через ВКонтакте
            </p>
          </div>

          {/* Единственная защищённая кнопка входа через VK ID */}
          <button
          ...
          <p className="text-xs text-gray-400 leading-relaxed">
            Авторизуясь, вы подтверждаете согласие с условиями использования сервиса.
          </p>
        </div>
      </div>
    </div>
