...
export default function UserDropdown() {
  ...
  useEffect(() => {
    // 🔍 1. Ищем ID в параметрах URL (переход из ВК/приложения)
      ...
      >
        ...
        {userId && (
          <button
            ...
            className="flex items-center gap-3 w-full px-3 py-2 mt-3 font-medium text-red-500 rounded-lg group text-theme-sm hover:bg-red-50 dark:hover:bg-red-950/30 transition text-left cursor-pointer"
          >
            <svg
